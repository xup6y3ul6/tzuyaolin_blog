...
subtitle: "An example of doing factor analysis and logistic regession"
author: "Tzu-Yao Lin"
date: 2025-03-28
categories: 
  - "r"
...
It is recommended to report at least the factor loadings for the `fa5_ob` solution (Table @tbl-fa-loadings), potentially using a **cutoff (= 0.26)** for clarity ...
...
Logistic regression results for S1 are presented in Table @tbl-S1-result.
